                ...
                if deformable:
                    ...
                    for i in range(prototype_shape[-2]):
                        for k in range(prototype_shape[-1]):
                            ...
                            def_box_info[prototype_shape[-1] * i + k] = [def_image_space_row_start, def_image_space_row_end, def_image_space_col_start, def_image_space_col_end]
                            original_box_info[prototype_shape[-1] * i + k] = [image_space_row_start, image_space_row_end, image_space_col_start, image_space_col_end]

                    highest_patch = DeformedProtoImage(
                        def_box_info=def_box_info,
